...
let config = {
    ...
    personaRootName: 'https://happy-sea-0f8841c0f.1.azurestaticapps.net',
    guildRootName: 'https://nearguilds.live',
    daoRootName: 'https://happy-sea-0f8841c0f.1.azurestaticapps.net',
...
if (process.env.ENV === 'prod') {
    config = {
        ...
        APPSEED_CALL: 'https://vitalpointai-api.azurewebsites.net/api/seed',
